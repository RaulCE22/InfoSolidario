...
ActiveRecord::Schema.define(version: 20150417165657) do
  ...
  create_table "donacion_recursos", force: :cascade do |t|
    t.integer  "idOng"
    t.boolean  "schedule"
    t.text     "description"
    t.integer  "state"
  ...
  add_index "donantes", ["reset_password_token"], name: "index_donantes_on_reset_password_token", unique: true
